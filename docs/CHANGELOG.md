...
- **Checked, couldn't reproduce**: Podcasts click-to-open. The code path (`_PodcastCard.onTap` → `PodcastDetailsPage`) looks correct and unchanged in behavior; no UI automation available in this environment to confirm live.
