...
import 'package:playtorrio/widgets/common/library_tabs.dart';

Widget wrap(Widget child) => MaterialApp(home: child);

void main() {
  group('LibraryTabs', () {
    testWidgets('tapping a pill switches the TabBarView page',
        (tester) async {
      await tester.pumpWidget(wrap(LibraryTabs(
        title: 'Library',
