...
hubs (2026-08-27) found the same class of bug in Anime and the Read hub (the
Read-hub half shipped same day, see CHANGELOG), plus two missing favorites
features — items #2–#5 below.
