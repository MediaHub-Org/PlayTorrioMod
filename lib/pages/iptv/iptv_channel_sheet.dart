...
class _IptvChannelSheetState extends State<IptvChannelSheet> {
  ...
  void _playHit(int index, [Offset? tapPos]) {
    if (_ctrl.channelResults.isEmpty) return;
    ...
    Navigator.push(
      ...
      LiquidRevealRoute(
        page: IptvPlayerPage(
          ...
          hits: _ctrl.channelResults,
          initialHitIndex: index,
          isLive: true,
        ),
        tapPosition: tapPos,
      ),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          status.isNotEmpty ? status : '${results.length} live stream feeds available',
                          style: TextStyle(
